...
export const ReviewStep = () => {
  ...
  const labelClasses = "block text-[9px] uppercase font-bold tracking-[0.2em] text-astera-text/50 mb-1";
  ...
  return (
    <div className="space-y-12">
      <div className="border-b border-astera-border pb-4">
        ...
        <p className="text-astera-text/70 font-sans text-xs mt-1">Provjerite sve podatke prije konačne potvrde i plaćanja.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="space-y-8">
          <div>
            ...
            <div className="bg-astera-white rounded-2xl p-6 mt-3 space-y-1">
          ...
          <div>
            ...
            <div className="bg-astera-white rounded-2xl p-6 mt-3">
        ...
        <div className="space-y-8">
          <div>
            ...
            <div className="bg-astera-cream rounded-3xl p-8 mt-3 space-y-4">
              ...
              <div className="h-[1px] bg-astera-border/50 my-4" />
              ...
              <p className="text-[9px] text-astera-text/70 mt-6 uppercase tracking-widest text-center italic">
          ...
          <button
            ...
            disabled={loading}
            className="w-full btn-bespoke-elegant !bg-astera-dark !text-white hover:!bg-black py-7 rounded-2xl font-sans font-bold text-[13px] uppercase tracking-[0.4em] transition-all duration-500 shadow-2xl shadow-black/10 hover:shadow-black/20 hover:-translate-y-1 relative overflow-hidden group disabled:opacity-50 disabled:cursor-not-allowed border-none"
          >
